...
public class StrategyDemo {
    public void testStrategy() {
        ...
        int result = operation.operation(10, 20);
        Log.d("StrategyDemo", "result:" + result);

        operation.setOperation(new MultiOperation());
        int result2 = operation.operation(10, 20);
        Log.d("StrategyDemo", "result2:" + result2);
    }
}
